...
function quest_122387_features() {
  let actionAnims = {};
  ...
  document.getElementById("Cari-Sekarang").addEventListener("mouseenter", function() {

    let anim_122387_2_out_122387_1 = actionAnims["anim_122387_2_out_122387_1"];

    if (anim_122387_2_out_122387_1) {
      anim_122387_2_out_122387_1.pause();
      anim_122387_2_out_122387_1.reverse();
      anim_122387_2_out_122387_1.play();
    } else {

      let anim_122387_2_out_122387_1 = anime({
        targets: "#Cari-Sekarang",
        scale: {
          value: 1.1,
          duration: 100,
          delay: 0,
      ...
      actionAnims["anim_122387_2_out_122387_1"] = anim_122387_2_out_122387_1;

    }

  });

  document.getElementById("Cari-Sekarang").addEventListener("mouseleave", function() {
  ...
  document.getElementById("Group-106").addEventListener("mouseenter", function() {

    let anim_122387_3_out_122387_2 = actionAnims["anim_122387_3_out_122387_2"];

    if (anim_122387_3_out_122387_2) {
      anim_122387_3_out_122387_2.pause();
      anim_122387_3_out_122387_2.reverse();
      anim_122387_3_out_122387_2.play();
    } else {

      let anim_122387_3_out_122387_2 = anime({
        targets: "#Group-106",
        scale: {
          value: 1.1,
          duration: 100,
      ...
      actionAnims["anim_122387_3_out_122387_2"] = anim_122387_3_out_122387_2;

    }

  });

  document.getElementById("Group-106").addEventListener("mouseleave", function() {
  ...
  let anim_122387_4_in_122387_3 = actionAnims["anim_122387_4_in_122387_3"];

  if (anim_122387_4_in_122387_3) {
    anim_122387_4_in_122387_3.restart();
  } else {

    let anim_122387_4_in_122387_3 = anime({
      targets: "#A-LIVE-moderated-pla",
      translateX: {
        value: [-100, 0],
        duration: 750,
        delay: 500,
    ...
    actionAnims["anim_122387_4_in_122387_3"] = anim_122387_4_in_122387_3;

  }


  document.getElementById("Group-114").addEventListener("mouseenter", function() {

    let anim_122387_5_out_122387_4 = actionAnims["anim_122387_5_out_122387_4"];

    if (anim_122387_5_out_122387_4) {
      anim_122387_5_out_122387_4.pause();
      anim_122387_5_out_122387_4.reverse();
      anim_122387_5_out_122387_4.play();
    } else {

      let anim_122387_5_out_122387_4 = anime({
        targets: "#Group-114",
        scale: {
          value: 1.1,
          duration: 100,
      ...
      actionAnims["anim_122387_5_out_122387_4"] = anim_122387_5_out_122387_4;

    }

  });

  document.getElementById("Group-114").addEventListener("mouseleave", function() {
  ...
  let anim_122387_6_in_122387_5 = actionAnims["anim_122387_6_in_122387_5"];

  if (anim_122387_6_in_122387_5) {
    anim_122387_6_in_122387_5.restart();
  } else {

    let anim_122387_6_in_122387_5 = anime({
      targets: "#Vectary-texture",
      translateX: {
        value: [100, 0],
        duration: 750,
        delay: 500,
    ...
    actionAnims["anim_122387_6_in_122387_5"] = anim_122387_6_in_122387_5;

  }


  document.getElementById("Group-36").addEventListener("mouseenter", function() {

    let anim_122387_9_out_122387_6 = actionAnims["anim_122387_9_out_122387_6"];

    if (anim_122387_9_out_122387_6) {
      anim_122387_9_out_122387_6.pause();
      anim_122387_9_out_122387_6.reverse();
      anim_122387_9_out_122387_6.play();
    } else {

      let anim_122387_9_out_122387_6 = anime({
        targets: "#Group-36",
        scale: {
          value: 1.1,
          duration: 100,
      ...
      actionAnims["anim_122387_9_out_122387_6"] = anim_122387_9_out_122387_6;

    }

  });

  document.getElementById("Group-36").addEventListener("mouseleave", function() {
  ...
  let anim_122387_10_in_122387_7 = actionAnims["anim_122387_10_in_122387_7"];

  if (anim_122387_10_in_122387_7) {
    anim_122387_10_in_122387_7.restart();
  } else {

    let anim_122387_10_in_122387_7 = anime({
      targets: "#A-LIVE-moderated-pla-1",
      translateX: {
        value: [-100, 0],
        duration: 750,
        delay: 500,
    ...
    actionAnims["anim_122387_10_in_122387_7"] = anim_122387_10_in_122387_7;
...
document.addEventListener("DOMContentLoaded", quest_122387_features);
0
0
